            ...
            <div className="lg:col-span-2">
              <div className="rounded-2xl border border-white/10 bg-neutral-900/70 shadow-sm overflow-hidden">
                ...
                <dl className="divide-y divide-white/10">
                  ...
                  {/* 電話番号 */}
                  <div className="mt-4">
                    <h3 className="text-lg font-semibold text-white">電話番号</h3>
                    <p className="text-gray-300">03-6281-5886</p>
                  </div>
    ...
    <div className="sticky top-0 z-50 backdrop-blur bg-black/70 border-b border-white/10">
      <div className="mx-auto max-w-7xl px-4 h-16 flex items-center justify-between">
        <a href="/#top" className="flex items-center gap-2">
          <img src="/illustrations/logo.svg" alt="logo" className="h-14 w-auto" />
